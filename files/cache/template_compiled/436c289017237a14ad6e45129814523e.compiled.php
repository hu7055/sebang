...
<?php if($__Context->act === 'dispMenuAdminSiteMap'){ ?><div class="admin-forum-container" data-chak-categories="XE설정:사이트 메뉴 편집"></div><?php } ?>
<?php if($__Context->act === 'dispMenuAdminSiteDesign'){ ?><div class="admin-forum-container" data-chak-categories="XE설정:사이트 디자인 설정"></div><?php } ?>
