...
${'category_srl13_argument'} = new ConditionArgument('category_srl', $args->category_srl, 'equal');
...
${'sort_index14_argument'}->ensureDefaultValue('document_srl');
...
,new ConditionWithArgument('`category_srl`',$category_srl13_argument,"equal", 'and')))
));
